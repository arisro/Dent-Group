desc "convert a latin1 database with utf8 data into proper utf8"
  task :convert_to_utf8 => :environment do
    ...
    conn.run_sql "ALTER DATABASE drs_dev CHARACTER SET utf8 collate utf8_unicode_ci"
    conn.run_sql "ALTER DATABASE drs CHARACTER SET utf8 collate utf8_unicode_ci"
